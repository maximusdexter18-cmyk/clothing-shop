...
import ProductPopup from "@/components/ProductPopup"; // THE HOMEPAGE POPUP!
...
export default function ShopPage() {
  ...
  // Added success state for the card
  ...
  return (
    <>
      ...
      <main className="min-h-screen bg-transparent pt-32">
        ...
        {(selectedGender || selectedCategory || selectedBrand || availability !== "all") && (
          <div className="max-w-7xl mx-auto px-6 lg:px-8 mb-4">
            <div className="flex flex-wrap items-center gap-2 justify-center">
              ...
              {selectedGender && (
                <button onClick={() => { setSelectedGender(null); setSelectedCategory(null); }} className="flex items-center gap-1 px-3 py-1 bg-luxury-gold text-luxury-brown rounded-full text-xs font-bold hover:bg-white/80 transition-all">
                  {selectedGender.charAt(0).toUpperCase() + selectedGender.slice(1)} <span className="text-xs">×</span>
                </button>
              )}
              {selectedCategory && (
        ...
        <div className="sticky top-20 z-30 bg-gradient-to-r from-black/70 to-black/40 backdrop-blur-md border-b border-white/10 py-3 px-4">
          <div className="max-w-7xl mx-auto flex items-center gap-2 overflow-x-auto hide-scrollbar">
            ...
            >
              ...
              Filters
              {(selectedBrand || availability !== "all" || selectedCategory || selectedGender) && <span className="w-2 h-2 rounded-full bg-luxury-gold" />}
            </button>
        ...
        {/* Products Grid - Now with Homepage-style cards */}
